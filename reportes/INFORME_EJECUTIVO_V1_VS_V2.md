...
| Pendiente | Confirmación visual del Arquitecto de que el login funciona en el navegador real tras el fix de autofill (sigue sin poder verificarse la consola F12 desde este entorno) | ⏳ Requiere prueba manual |
